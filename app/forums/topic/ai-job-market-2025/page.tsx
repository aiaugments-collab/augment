...
export const metadata: Metadata = {
  title: 'AI Job Market Trends 2025 | Augment AI',
  description: 'Discussion about current trends in the AI job market, in-demand skills, and career opportunities.',
};

export default function AIJobMarketTrends2025Page() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Job Market Trends 2025</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            AI Job Market Trends 2025
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discussion about current trends in the AI job market, in-demand skills, and career opportunities.
          </p>
