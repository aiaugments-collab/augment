...
export const metadata: Metadata = {
  title: 'Industry-Specific Discussions | Augment AI',
  description: 'Focused discussions on AI applications in healthcare, finance, manufacturing, retail, and other industries.',
};

export default function IndustrySpecificDiscussionsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Industry-Specific Discussions</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Focused discussions on AI applications in healthcare, finance, manufacturing, retail, and other industries.
          </p>
