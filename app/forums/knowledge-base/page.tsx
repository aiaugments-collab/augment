...
export const metadata: Metadata = {
  title: 'Knowledge Sharing | Augment AI',
...
export default function KnowledgeSharingPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Knowledge Sharing</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Share your expertise, learn from others, and contribute to the collective AI knowledge base.
          </p>
