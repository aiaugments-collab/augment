...
export const metadata: Metadata = {
  title: 'Community Guidelines | Augment AI',
  description: 'Guidelines and rules for participating in our community forums and discussions.',
};

export default function CommunityGuidelinesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Community Guidelines</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Guidelines and rules for participating in our community forums and discussions.
          </p>
