...
export const metadata: Metadata = {
  title: 'Video Tutorials | Augment AI',
...
export default function VideoTutorialsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Video Tutorials</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Watch step-by-step video tutorials covering product features and common use cases.
          </p>
