...
export const metadata: Metadata = {
  title: 'Getting Started Guides | Augment AI',
  description: 'Quick start guides and initial setup instructions for all Augment AI products and solutions.',
};

export default function GettingStartedGuidesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Getting Started Guides</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Quick start guides and initial setup instructions for all Augment AI products and solutions.
          </p>
