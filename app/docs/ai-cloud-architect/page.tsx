      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-8">
        <div className="docs-content">
          ...
          <div id="overview" className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI CloudArchitect</h1>
              <p className="text-lg text-gray-600">Intelligent multi-cloud architecture optimization</p>
            </div>
          </div>
...
cloud-architect dr-plan --primary aws --secondary azure`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                ...
                <p className="text-sm text-green-800">Optimize instance sizes based on actual usage patterns</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <h5 className="font-semibold text-blue-900 mb-2">Reserved Instances</h5>
                <p className="text-sm text-blue-800">Identify opportunities for reserved capacity savings</p>
              </div>
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                <h5 className="font-semibold text-purple-900 mb-2">Spot Instances</h5>
                <p className="text-sm text-purple-800">Recommend spot instance usage for fault-tolerant workloads</p>
              </div>
            </div>
