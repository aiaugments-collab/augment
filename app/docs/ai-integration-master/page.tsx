      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-8">
        <div className="docs-content">
          ...
          <div id="overview" className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI IntegrationMaster</h1>
              <p className="text-lg text-gray-600">Smart integration pattern detection</p>
            </div>
          </div>
                ...
                <div className="p-6">
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                      ...
                      <div className="text-sm text-orange-700">Auto-Remediated Issues</div>
                    </div>
                  </div>
