      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-8">
        <div className="docs-content">
          ...
          <div id="overview" className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI DataFlow</h1>
              <p className="text-lg text-gray-600">Intelligent data pipeline optimization</p>
            </div>
          </div>
                ...
                <div className="p-6">
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                      ...
                      <div className="text-sm text-blue-700">Data Processed Today</div>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                      <div className="text-2xl font-bold text-purple-600">43%</div>
                      <div className="text-sm text-purple-700">Performance Improvement</div>
                    </div>
                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                      <div className="text-2xl font-bold text-orange-600">99.7%</div>
                      <div className="text-sm text-orange-700">Data Quality Score</div>
                    </div>
                  </div>
