      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-8">
        <div className="docs-content">
          ...
          <div id="overview" className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI CloudOptimizer</h1>
              <p className="text-lg text-gray-600">Intelligent resource optimization and cost prediction</p>
            </div>
          </div>
                ...
                <div className="p-6">
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                      ...
                      <div className="text-sm text-blue-700">Resources Optimized</div>
                    </div>
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                      ...
                      <div className="text-sm text-orange-700">Continuous Optimization</div>
                    </div>
                  </div>
  ...
  --growth-trends          Account for growth trends`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-sm text-blue-800">Predict based on historical linear growth patterns</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                <h5 className="font-semibold text-green-900 mb-2">Seasonal Patterns</h5>
                <p className="text-sm text-green-800">Account for daily, weekly, and monthly usage cycles</p>
              </div>
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                <h5 className="font-semibold text-purple-900 mb-2">Machine Learning</h5>
                <p className="text-sm text-purple-800">Advanced ML models for complex usage patterns</p>
              </div>
            </div>
