      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-8">
        <div className="docs-content">
          ...
          <div id="overview" className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI SecurityAuditor</h1>
              <p className="text-lg text-gray-600">AI-powered comprehensive security analysis</p>
            </div>
          </div>
          ...
          path: security-report.html`}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 text-center">
                ...
                <div className="text-sm text-blue-700">Type I & II</div>
              </div>
              <div className="bg-green-50 p-3 rounded-lg border border-green-200 text-center">
                <div className="font-semibold text-green-900">ISO 27001</div>
                <div className="text-sm text-green-700">Full Controls</div>
              </div>
              <div className="bg-purple-50 p-3 rounded-lg border border-purple-200 text-center">
                <div className="font-semibold text-purple-900">GDPR</div>
                <div className="text-sm text-purple-700">Privacy Controls</div>
              </div>
              <div className="bg-red-50 p-3 rounded-lg border border-red-200 text-center">
                <div className="font-semibold text-red-900">HIPAA</div>
                <div className="text-sm text-red-700">Healthcare Security</div>
              </div>
              <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200 text-center">
                <div className="font-semibold text-yellow-900">PCI DSS</div>
                <div className="text-sm text-yellow-700">Payment Security</div>
              </div>
              <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 text-center">
                <div className="font-semibold text-gray-900">NIST</div>
                <div className="text-sm text-gray-700">Cybersecurity Framework</div>
              </div>
            </div>
