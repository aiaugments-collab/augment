      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-8">
        <div className="docs-content">
          ...
          <div id="overview" className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI MonitorIQ</h1>
              <p className="text-lg text-gray-600">Intelligent monitoring setup with predictive alerts</p>
            </div>
          </div>
                ...
                <div className="p-6">
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                      ...
                      <div className="text-sm text-green-700">Monitors Active</div>
                    </div>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                      ...
                      <div className="text-sm text-purple-700">Predicted Issues</div>
                    </div>
                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                      <div className="text-2xl font-bold text-orange-600">67%</div>
                      <div className="text-sm text-orange-700">Alert Accuracy</div>
                    </div>
                  </div>
