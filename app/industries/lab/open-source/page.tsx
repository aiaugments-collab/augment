...
export const metadata: Metadata = {
  title: 'Open Source Initiatives | Augment AI',
...
export default function OpenSourceInitiativesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Open Source Initiatives</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Contribute to and benefit from open-source AI projects that advance the entire industry and research community.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Contribute to and benefit from open-source AI projects that advance the entire industry and research community. Learn more about our comprehensive solutions and how they can benefit your organization.
          </p>
      ...
      <section className="py-16 bg-[#4A90E2] text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-blue-100 mb-8">
            Contact our team to learn more about open source initiatives and how it can benefit your organization.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
