...
export const metadata: Metadata = {
  title: 'Multi-Modal AI Agents | Augment AI',
  description: 'Next-generation AI agents that seamlessly integrate text, vision, audio, and sensor data for comprehensive understanding.',
};

export default function MultiModalAIAgentsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Multi-Modal AI Agents</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Next-generation AI agents that seamlessly integrate text, vision, audio, and sensor data for comprehensive understanding. Learn more about our comprehensive solutions and how they can benefit your organization.
          </p>
      ...
      <section className="py-16 bg-[#4A90E2] text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-blue-100 mb-8">
            Contact our team to learn more about multi-modal ai agents and how it can benefit your organization.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
