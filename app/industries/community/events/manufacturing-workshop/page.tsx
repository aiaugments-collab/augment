...
export const metadata: Metadata = {
  title: 'Manufacturing AI Workshop | Augment AI',
  description: 'Hands-on workshop covering predictive maintenance, quality control, and production optimization.',
};

export default function ManufacturingAIWorkshopPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Manufacturing AI Workshop</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Hands-on workshop covering predictive maintenance, quality control, and production optimization. Learn more about our comprehensive solutions and how they can benefit your organization.
          </p>
      ...
      <section className="py-16 bg-[#4A90E2] text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-blue-100 mb-8">
            Contact our team to learn more about manufacturing ai workshop and how it can benefit your organization.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
