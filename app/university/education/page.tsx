...
export const metadata: Metadata = {
  title: 'World-Class Education | Augment AI',
  description: 'Learn from leading AI researchers and industry experts with cutting-edge curriculum and hands-on experience.',
};

export default function WorldClassEducationPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">World-Class Education</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn from leading AI researchers and industry experts with cutting-edge curriculum and hands-on experience.
          </p>
