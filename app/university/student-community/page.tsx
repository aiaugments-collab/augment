...
export const metadata: Metadata = {
  title: 'Global Student Community | Augment AI',
  description: 'Connect with AI students worldwide, collaborate on projects, and participate in academic competitions.',
};

export default function GlobalStudentCommunityPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Global Student Community</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Connect with AI students worldwide, collaborate on projects, and participate in academic competitions.
          </p>
