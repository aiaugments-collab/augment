...
export const metadata: Metadata = {
  title: 'Solution Implementation Partners | Augment AI',
  description: 'Consulting firms and system integrators that help customers implement and optimize Augment AI solutions.',
};

export default function SolutionImplementationPartnersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Solution Implementation Partners</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Consulting firms and system integrators that help customers implement and optimize Augment AI solutions.
          </p>
