...
export const metadata: Metadata = {
  title: 'Partner Advisory Council | Augment AI',
  description: 'Join our partner advisory council to influence product roadmap and partnership strategy.',
};

export default function PartnerAdvisoryCouncilPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Partner Advisory Council</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Join our partner advisory council to influence product roadmap and partnership strategy.
          </p>
