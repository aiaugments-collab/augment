...
export const metadata: Metadata = {
  title: 'Innovation Lab Partnership | Augment AI',
  description: 'Collaborate on cutting-edge AI research and development in our innovation labs.',
};

export default function InnovationLabPartnershipPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Innovation Lab Partnership</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Collaborate on cutting-edge AI research and development in our innovation labs.
          </p>
