...
export const metadata: Metadata = {
  title: 'Partner Certification Program | Augment AI',
  description: 'Comprehensive certification program to validate partner expertise and ensure customer success.',
};

export default function PartnerCertificationProgramPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Partner Certification Program</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Comprehensive certification program to validate partner expertise and ensure customer success.
          </p>
