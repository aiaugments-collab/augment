...
export const metadata: Metadata = {
  title: 'Technical Resources & Support | Augment AI',
  description: 'Comprehensive technical documentation, APIs, SDKs, and dedicated partner engineering support.',
};

export default function TechnicalResourcesSupportPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Technical Resources & Support</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Comprehensive technical documentation, APIs, SDKs, and dedicated partner engineering support.
          </p>
