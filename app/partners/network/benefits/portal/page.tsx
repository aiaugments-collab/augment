...
export const metadata: Metadata = {
  title: 'Dedicated Partner Portal | Augment AI',
  description: 'Access to partner-only resources, deal registration, lead management, and performance analytics.',
};

export default function DedicatedPartnerPortalPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Dedicated Partner Portal</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Access to partner-only resources, deal registration, lead management, and performance analytics.
          </p>
