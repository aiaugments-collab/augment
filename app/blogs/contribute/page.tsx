...
export const metadata: Metadata = {
  title: 'Become a Contributor | Augment AI',
  description: 'Share your AI expertise and insights with our global community. We welcome guest contributors and thought leaders.',
};

export default function BecomeaContributorPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Become a Contributor</h1>
