...
export const metadata: Metadata = {
  title: 'International Track | Augment AI',
  description: 'Support for international startups looking to expand to new markets or establish global presence.',
};

export default function InternationalTrackPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">International Track</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Support for international startups looking to expand to new markets or establish global presence.
          </p>
