...
export const metadata: Metadata = {
  title: 'Vertical AI Track | Augment AI',
  description: 'Industry-specific track for startups building AI solutions for healthcare, finance, and other verticals.',
};

export default function VerticalAITrackPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Vertical AI Track</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Industry-specific track for startups building AI solutions for healthcare, finance, and other verticals.
          </p>
