...
export const metadata: Metadata = {
  title: 'Early Stage Track | Augment AI',
  description: 'For pre-seed and seed stage startups building AI-first products and solutions with our platform.',
};

export default function EarlyStageTrackPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Early Stage Track</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            For pre-seed and seed stage startups building AI-first products and solutions with our platform.
          </p>
