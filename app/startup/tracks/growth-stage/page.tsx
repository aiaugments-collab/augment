...
export const metadata: Metadata = {
  title: 'Growth Stage Track | Augment AI',
  description: 'For Series A+ startups scaling AI solutions and looking for strategic partnerships.',
};

export default function GrowthStageTrackPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Growth Stage Track</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            For Series A+ startups scaling AI solutions and looking for strategic partnerships.
          </p>
