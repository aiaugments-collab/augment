...
export const metadata: Metadata = {
  title: 'FinTech IPO Journey | Augment AI',
  description: 'A fintech startup that went from program participant to successful IPO in just 4 years.',
};

export default function FinTechIPOJourneyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">FinTech IPO Journey</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            A fintech startup that went from program participant to successful IPO in just 4 years.
          </p>
