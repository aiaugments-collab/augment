...
export const metadata: Metadata = {
  title: 'Go-to-Market Support | Augment AI',
  description: 'Marketing resources, co-marketing opportunities, and access to our customer base for validation.',
};

export default function GotoMarketSupportPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Go-to-Market Support</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Marketing resources, co-marketing opportunities, and access to our customer base for validation.
          </p>
