...
export const metadata: Metadata = {
  title: 'Investor Network Access | Augment AI',
  description: 'Exclusive access to our network of VCs, angel investors, and strategic partners for funding opportunities.',
};

export default function InvestorNetworkAccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Investor Network Access</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Exclusive access to our network of VCs, angel investors, and strategic partners for funding opportunities.
          </p>
