...
export const metadata: Metadata = {
  title: 'Healthcare ROI Calculator | Augment AI',
  description: 'Calculate potential returns from AI automation in healthcare.',
};

export default function HealthcareROICalculatorPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Healthcare ROI Calculator</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Calculate potential returns from AI automation in healthcare.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Calculate potential returns from AI automation in healthcare. Our comprehensive solutions are designed to deliver measurable results and drive business transformation.
          </p>
      ...
      <section className="py-16 bg-[#4A90E2] text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-blue-100 mb-8">
            Contact our team to learn more about healthcare roi calculator and how it can transform your organization.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
