...
export const metadata: Metadata = {
  title: 'Early Access to AI Innovations | Augment AI',
  description: 'Get exclusive access to new features, research findings, and beta programs from Augment and partners.',
};

export default function EarlyAccesstoAIInnovationsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Early Access to AI Innovations</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Get exclusive access to new features, research findings, and beta programs from Augment and partners.
          </p>
