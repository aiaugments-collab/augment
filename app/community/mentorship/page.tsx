...
export const metadata: Metadata = {
  title: 'Mentorship and Career Growth | Augment AI',
  description: 'Connect with mentors, advance your AI career, and help others grow in the field of artificial intelligence.',
};

export default function MentorshipandCareerGrowthPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Mentorship and Career Growth</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Connect with mentors, advance your AI career, and help others grow in the field of artificial intelligence.
          </p>
