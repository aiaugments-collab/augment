...
export const metadata: Metadata = {
  title: 'Data Scientists & Analysts | Augment AI',
  description: 'Data science methodologies, machine learning techniques, and analytics best practices.',
};

export default function DataScientistsAnalystsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Data Scientists & Analysts</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Data science methodologies, machine learning techniques, and analytics best practices.
          </p>
