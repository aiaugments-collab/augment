...
export const metadata: Metadata = {
  title: 'Students & Learners | Augment AI',
  description: 'Learning resources, study groups, and support for students and newcomers to artificial intelligence.',
};

export default function StudentsLearnersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Students & Learners</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learning resources, study groups, and support for students and newcomers to artificial intelligence.
          </p>
