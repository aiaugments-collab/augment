...
export const metadata: Metadata = {
  title: 'Flexible Learning Options | Augment AI',
  description: 'Choose from self-paced online courses, live virtual sessions, or in-person workshops.',
};

export default function FlexibleLearningOptionsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Flexible Learning Options</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Choose from self-paced online courses, live virtual sessions, or in-person workshops.
          </p>
