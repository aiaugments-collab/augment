...
export const metadata: Metadata = {
  title: 'AI Data Science Bootcamp | Augment AI',
  description: 'Intensive hands-on training in data science, machine learning model development, and AI system deployment.',
};

export default function AIDataScienceBootcampPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Data Science Bootcamp</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Intensive hands-on training in data science, machine learning model development, and AI system deployment.
          </p>
