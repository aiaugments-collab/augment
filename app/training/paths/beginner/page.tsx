...
export const metadata: Metadata = {
  title: 'Beginner Learning Path | Augment AI',
  description: 'Start your AI journey with foundational concepts, basic implementations, and hands-on projects.',
};

export default function BeginnerLearningPathPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Beginner Learning Path</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Start your AI journey with foundational concepts, basic implementations, and hands-on projects.
          </p>
