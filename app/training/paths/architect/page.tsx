...
export const metadata: Metadata = {
  title: 'AI Architect Path | Augment AI',
  description: 'Enterprise-level training for designing and implementing large-scale AI architectures and solutions.',
};

export default function AIArchitectPathPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Architect Path</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Enterprise-level training for designing and implementing large-scale AI architectures and solutions.
          </p>
