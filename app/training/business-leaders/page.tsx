...
export const metadata: Metadata = {
  title: 'AI for Business Leaders | Augment AI',
...
export default function AIforBusinessLeadersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI for Business Leaders</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Strategic AI training for executives and business leaders focused on AI adoption, ROI, and organizational transformation.
          </p>
