...
export const metadata: Metadata = {
  title: 'Training Certifications | Augment AI',
  description: 'Industry-recognized certifications that validate your AI expertise and advance your career.',
};

export default function TrainingCertificationsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Training Certifications</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Industry-recognized certifications that validate your AI expertise and advance your career.
          </p>
