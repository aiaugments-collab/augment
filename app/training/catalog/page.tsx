...
export const metadata: Metadata = {
  title: 'Browse Course Catalog | Augment AI',
  description: 'Explore our comprehensive catalog of AI training courses and certification programs.',
};

export default function BrowseCourseCatalogPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Browse Course Catalog</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Explore our comprehensive catalog of AI training courses and certification programs.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-gray-700 max-w-3xl mx-auto mb-8" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover how our comprehensive training solutions can help you achieve your goals and drive success.
          </p>
