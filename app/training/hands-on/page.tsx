...
export const metadata: Metadata = {
  title: 'Hands-On Learning Experience | Augment AI',
  description: 'Learn through practical projects, real-world case studies, and interactive coding exercises.',
};

export default function HandsOnLearningExperiencePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Hands-On Learning Experience</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn through practical projects, real-world case studies, and interactive coding exercises.
          </p>
