...
export const metadata: Metadata = {
  title: 'AI Ethics & Governance | Augment AI',
  description: 'Learn responsible AI development, ethical considerations, bias mitigation, and AI governance frameworks.',
};

export default function AIEthicsGovernancePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Ethics & Governance</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn responsible AI development, ethical considerations, bias mitigation, and AI governance frameworks.
          </p>
