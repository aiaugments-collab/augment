...
export const metadata: Metadata = {
  title: 'Expert Instructor Network | Augment AI',
  description: 'Learn from industry experts, AI researchers, and practitioners with real-world experience.',
};

export default function ExpertInstructorNetworkPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Expert Instructor Network</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn from industry experts, AI researchers, and practitioners with real-world experience.
          </p>
