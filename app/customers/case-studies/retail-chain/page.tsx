...
export const metadata: Metadata = {
  title: 'Retail Chain Case Study | Augment AI',
  description: 'Global retailer transformed customer experience and sales performance with Augment Search AI technology.',
};

export default function RetailChainCaseStudyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Retail Chain Case Study</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Global retailer transformed customer experience and sales performance with Augment Search AI technology.
          </p>
