...
export const metadata: Metadata = {
  title: 'Case Study ROI Analysis | Augment AI',
  description: 'Access detailed financial impact and return on investment metrics from real customer implementations.',
};

export default function CaseStudyROIAnalysisPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Case Study ROI Analysis</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Access detailed financial impact and return on investment metrics from real customer implementations.
          </p>
