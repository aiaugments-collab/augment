...
export const metadata: Metadata = {
  title: 'Implementation Insights | Augment AI',
  description: 'Learn about deployment strategies, challenges overcome, and best practices from successful projects.',
};

export default function ImplementationInsightsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Implementation Insights</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn about deployment strategies, challenges overcome, and best practices from successful projects.
          </p>
