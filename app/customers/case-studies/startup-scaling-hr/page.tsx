...
export const metadata: Metadata = {
  title: 'Startup HR Scaling Success | Augment AI',
  description: 'Fast-growing startup scaled hiring process 10x faster using Augment Resume AI for automated screening.',
};

export default function StartupHRScalingSuccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Startup HR Scaling Success</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Startup HR Scaling Success
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Fast-growing startup scaled hiring process 10x faster using Augment Resume AI for automated screening.
          </p>
