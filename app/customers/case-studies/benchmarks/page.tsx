...
export const metadata: Metadata = {
  title: 'Industry Benchmarks | Augment AI',
...
export default function IndustryBenchmarksPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Industry Benchmarks</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Compare performance metrics and outcomes against industry standards and peer organizations.
          </p>
