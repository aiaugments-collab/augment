...
export const metadata: Metadata = {
  title: 'Government Agency Case Study | Augment AI',
  description: 'Government department dramatically improved citizen services and operational efficiency with Augment AI solutions.',
};

export default function GovernmentAgencyCaseStudyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Government Agency Case Study</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Government department dramatically improved citizen services and operational efficiency with Augment AI solutions.
          </p>
