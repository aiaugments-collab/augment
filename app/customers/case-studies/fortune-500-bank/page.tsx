...
export const metadata: Metadata = {
  title: 'Fortune 500 Bank Case Study | Augment AI',
  description: 'Major financial institution achieved breakthrough results in fraud prevention and customer satisfaction with Augment Finance AI.',
};

export default function Fortune500BankCaseStudyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Fortune 500 Bank Case Study</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Major financial institution achieved breakthrough results in fraud prevention and customer satisfaction with Augment Finance AI.
          </p>
