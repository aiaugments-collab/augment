...
export const metadata: Metadata = {
  title: 'Mid-Market Companies | Augment AI',
  description: 'Learn how growing companies are using Augment AI to scale operations, improve efficiency, and accelerate growth.',
};

export default function MidMarketCompaniesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Mid-Market Companies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn how growing companies are using Augment AI to scale operations, improve efficiency, and accelerate growth.
          </p>
