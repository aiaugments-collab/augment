...
export const metadata: Metadata = {
  title: 'Government & Public Sector | Augment AI',
  description: 'See how government agencies and public organizations are improving citizen services with AI-powered solutions.',
};

export default function GovernmentPublicSectorPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Government & Public Sector</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            See how government agencies and public organizations are improving citizen services with AI-powered solutions.
          </p>
