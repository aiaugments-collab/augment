...
export const metadata: Metadata = {
  title: 'Product Roadmap Influence | Augment AI',
  description: 'Directly influence the future of Augment AI products and features based on your real-world experience.',
};

export default function ProductRoadmapInfluencePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Product Roadmap Influence</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Directly influence the future of Augment AI products and features based on your real-world experience.
          </p>
