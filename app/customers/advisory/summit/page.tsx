...
export const metadata: Metadata = {
  title: 'Annual Advisory Summit | Augment AI',
  description: 'Attend our annual summit with keynotes, workshops, and networking with fellow advisory board members.',
};

export default function AnnualAdvisorySummitPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Annual Advisory Summit</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Annual Advisory Summit
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Attend our annual summit with keynotes, workshops, and networking with fellow advisory board members.
          </p>
