...
export const metadata: Metadata = {
  title: 'Exclusive Early Access | Augment AI',
  description: 'Get first access to new features, beta programs, and cutting-edge AI innovations before public release.',
};

export default function ExclusiveEarlyAccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Exclusive Early Access</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Get first access to new features, beta programs, and cutting-edge AI innovations before public release.
          </p>
