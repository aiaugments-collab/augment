...
export const metadata: Metadata = {
  title: 'Direct CEO Access | Augment AI',
  description: 'Regular touchpoints with our CEO and executive team to share feedback and strategic insights.',
};

export default function DirectCEOAccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Direct CEO Access</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Regular touchpoints with our CEO and executive team to share feedback and strategic insights.
          </p>
