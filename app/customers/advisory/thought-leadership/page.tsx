...
export const metadata: Metadata = {
  title: 'Thought Leadership Platform | Augment AI',
  description: 'Establish yourself as an AI thought leader through speaking opportunities and industry recognition.',
};

export default function ThoughtLeadershipPlatformPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Thought Leadership Platform</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Establish yourself as an AI thought leader through speaking opportunities and industry recognition.
          </p>
