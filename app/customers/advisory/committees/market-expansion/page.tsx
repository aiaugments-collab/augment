...
export const metadata: Metadata = {
  title: 'Market Expansion Committee | Augment AI',
  description: 'Advise on new market opportunities, geographic expansion, and go-to-market strategies.',
};

export default function MarketExpansionCommitteePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Market Expansion Committee</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Advise on new market opportunities, geographic expansion, and go-to-market strategies.
          </p>
