...
export const metadata: Metadata = {
  title: 'Product Strategy Committee | Augment AI',
  description: 'Guide overall product direction, feature prioritization, and long-term strategic planning for Augment AI.',
};

export default function ProductStrategyCommitteePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Product Strategy Committee</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Guide overall product direction, feature prioritization, and long-term strategic planning for Augment AI.
          </p>
