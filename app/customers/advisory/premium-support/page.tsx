...
export const metadata: Metadata = {
  title: 'Premium Support Access | Augment AI',
  description: 'Receive priority support, dedicated account management, and direct access to our engineering teams.',
};

export default function PremiumSupportAccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Premium Support Access</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Receive priority support, dedicated account management, and direct access to our engineering teams.
          </p>
