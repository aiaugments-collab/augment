...
export const metadata: Metadata = {
  title: 'Innovation Labs Preview | Augment AI',
  description: 'Exclusive previews of our innovation labs and research projects before public announcement.',
};

export default function InnovationLabsPreviewPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Innovation Labs Preview</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Innovation Labs Preview
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Exclusive previews of our innovation labs and research projects before public announcement.
          </p>
