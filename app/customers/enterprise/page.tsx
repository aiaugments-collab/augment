...
export const metadata: Metadata = {
  title: 'Enterprise Customers | Augment AI',
  description: 'Discover how Fortune 500 companies and large enterprises are leveraging Augment AI for digital transformation and competitive advantage.',
};

export default function EnterpriseCustomersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Enterprise Customers</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover how Fortune 500 companies and large enterprises are leveraging Augment AI for digital transformation and competitive advantage.
          </p>
