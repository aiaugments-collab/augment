...
export const metadata: Metadata = {
  title: 'Gain Recognition | Augment AI',
  description: 'Receive industry recognition for your innovative AI implementation and thought leadership.',
};

export default function GainRecognitionPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Gain Recognition</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Receive industry recognition for your innovative AI implementation and thought leadership.
          </p>
