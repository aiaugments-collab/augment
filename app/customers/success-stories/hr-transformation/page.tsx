...
export const metadata: Metadata = {
  title: 'HR Transformation Success | Augment AI',
  description: 'Tech company reduced time-to-hire by 65% and improved retention by 32% using Augment Resume AI.',
};

export default function HRTransformationSuccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">HR Transformation Success</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            HR Transformation Success
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Tech company reduced time-to-hire by 65% and improved retention by 32% using Augment Resume AI.
          </p>
