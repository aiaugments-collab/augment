...
export const metadata: Metadata = {
  title: 'Startups & Scale-ups | Augment AI',
  description: 'Explore how innovative startups are building AI-first products and services with the Augment AI platform.',
};

export default function StartupsScaleupsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Startups & Scale-ups</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Explore how innovative startups are building AI-first products and services with the Augment AI platform.
          </p>
