...
export const metadata: Metadata = {
  title: 'Provide Feedback | Augment AI',
  description: 'Share your feedback on our knowledge base articles and help us improve our documentation.',
};

export default function ProvideFeedbackPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Provide Feedback</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Share your feedback on our knowledge base articles and help us improve our documentation.
          </p>
