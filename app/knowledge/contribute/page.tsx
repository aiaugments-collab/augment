...
export const metadata: Metadata = {
  title: 'Contribute Article | Augment AI',
  description: 'Help other users by sharing your expertise and contributing articles to our knowledge base.',
};

export default function ContributeArticlePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Contribute Article</h1>
