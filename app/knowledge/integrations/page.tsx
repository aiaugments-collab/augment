...
export const metadata: Metadata = {
  title: 'Third-Party Integration Guide | Augment AI',
  description: 'Step-by-step instructions for integrating Augment AI with popular platforms and enterprise systems.',
};

export default function ThirdPartyIntegrationGuidePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Third-Party Integration Guide</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Step-by-step instructions for integrating Augment AI with popular platforms and enterprise systems.
          </p>
