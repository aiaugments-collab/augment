...
export const metadata: Metadata = {
  title: 'API Authentication and Security | Augment AI',
  description: 'Learn how to securely authenticate with Augment APIs, manage API keys, and implement security best practices.',
};

export default function APIAuthenticationandSecurityPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">API Authentication and Security</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn how to securely authenticate with Augment APIs, manage API keys, and implement security best practices.
          </p>
