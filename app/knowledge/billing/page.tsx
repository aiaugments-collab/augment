...
export const metadata: Metadata = {
  title: 'Billing and Account Management | Augment AI',
  description: 'Manage your subscription, understand billing cycles, and configure account settings and permissions.',
};

export default function BillingandAccountManagementPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Billing and Account Management</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Manage your subscription, understand billing cycles, and configure account settings and permissions.
          </p>
