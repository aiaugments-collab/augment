...
export const metadata: Metadata = {
  title: 'Meet Speakers | Augment AI',
  description: 'Learn from leading AI researchers, practitioners, and industry experts at our events.',
};

export default function MeetSpeakersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Meet Speakers</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn from leading AI researchers, practitioners, and industry experts at our events.
          </p>
