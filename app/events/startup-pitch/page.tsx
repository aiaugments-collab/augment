...
export const metadata: Metadata = {
  title: 'AI Startup Pitch Competition | Augment AI',
  description: 'Pitch your AI startup to investors and industry experts. $100K in prizes and funding opportunities.',
};

export default function AIStartupPitchCompetitionPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Startup Pitch Competition</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Pitch your AI startup to investors and industry experts. $100K in prizes and funding opportunities.
          </p>
