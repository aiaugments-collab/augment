...
export const metadata: Metadata = {
  title: 'AI Research Symposium | Augment AI',
  description: 'Academic symposium featuring latest research in machine learning, neural networks, and AI applications.',
};

export default function AIResearchSymposiumPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Research Symposium</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Academic symposium featuring latest research in machine learning, neural networks, and AI applications.
          </p>
