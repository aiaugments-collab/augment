...
export const metadata: Metadata = {
  title: 'Host an Event | Augment AI',
  description: 'Partner with us to host AI events, workshops, or conferences. Reach our global community of AI professionals.',
};

export default function HostanEventPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Host an Event</h1>
