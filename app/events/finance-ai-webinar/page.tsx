...
export const metadata: Metadata = {
  title: 'Finance AI Transformation Webinar | Augment AI',
...
export default function FinanceAITransformationWebinarPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Finance AI Transformation Webinar</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Finance AI Transformation Webinar
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn how leading financial institutions are implementing AI for fraud detection, risk management, and customer service.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-gray-700 max-w-3xl mx-auto mb-8" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover how our comprehensive events solutions can help you achieve your goals and drive success.
          </p>
