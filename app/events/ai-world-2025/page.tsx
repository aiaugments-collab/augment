...
export const metadata: Metadata = {
  title: 'Augment AI World 2025 Conference | Augment AI',
...
export default function AugmentAIWorld2025ConferencePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Augment AI World 2025 Conference</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Augment AI World 2025 Conference
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Join 10,000+ AI professionals at the premier AI conference. Three days of keynotes, workshops, and networking in Las Vegas.
          </p>
