...
export const metadata: Metadata = {
  title: 'Healthcare AI Summit | Augment AI',
...
export default function HealthcareAISummitPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Healthcare AI Summit</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Explore the latest in healthcare AI applications, regulatory compliance, and clinical implementation strategies.
          </p>
