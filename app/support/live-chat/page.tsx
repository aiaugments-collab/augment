...
export const metadata: Metadata = {
  title: 'Live Chat Support | Augment AI',
...
export default function LiveChatSupportPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Live Chat Support</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Connect instantly with support agents through our live chat system for quick answers and real-time assistance.
          </p>
