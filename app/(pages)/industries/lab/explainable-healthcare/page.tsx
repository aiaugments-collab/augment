...
export const metadata: Metadata = {
  title: 'Explainable AI for Healthcare | Augment AI',
  description: 'Developing transparent AI systems that provide clear explanations for medical decisions, improving trust and adoption in healthcare.',
};

export default function ExplainableAIforHealthcarePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Explainable AI for Healthcare</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Developing transparent AI systems that provide clear explanations for medical decisions, improving trust and adoption in healthcare. Learn more about our comprehensive solutions and how they can benefit your organization.
          </p>
      ...
      <section className="py-16 bg-[#4A90E2] text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-blue-100 mb-8">
            Contact our team to learn more about explainable ai for healthcare and how it can benefit your organization.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
