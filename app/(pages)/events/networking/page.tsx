...
export const metadata: Metadata = {
  title: 'Networking Events | Augment AI',
...
export default function NetworkingEventsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Networking Events</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Professional networking events, career fairs, and industry mixer events for AI professionals.
          </p>
