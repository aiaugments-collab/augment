...
export const metadata: Metadata = {
  title: 'Find Opportunities | Augment AI',
  description: 'Discover job opportunities, meet recruiters, and advance your AI career at our events.',
};

export default function FindOpportunitiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Find Opportunities</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover job opportunities, meet recruiters, and advance your AI career at our events.
          </p>
