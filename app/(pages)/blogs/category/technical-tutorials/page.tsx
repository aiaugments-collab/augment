...
export const metadata: Metadata = {
  title: 'Technical Tutorials | Augment AI',
  description: 'Step-by-step guides, code examples, and hands-on tutorials for developers and technical practitioners.',
};

export default function TechnicalTutorialsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Technical Tutorials</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Step-by-step guides, code examples, and hands-on tutorials for developers and technical practitioners.
          </p>
