...
export const metadata: Metadata = {
  title: 'Manufacturing Revolution | Augment AI',
  description: 'Global automotive manufacturer achieved 35% cost reduction and 50% quality improvement with Augment Flow.',
};

export default function ManufacturingRevolutionPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Manufacturing Revolution</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Global automotive manufacturer achieved 35% cost reduction and 50% quality improvement with Augment Flow.
          </p>
