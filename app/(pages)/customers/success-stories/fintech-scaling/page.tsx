...
export const metadata: Metadata = {
  title: 'FinTech Scaling Success | Augment AI',
  description: 'A fintech startup scaled from 10K to 10M users in 18 months using Augment Finance AI for fraud detection.',
};

export default function FinTechScalingSuccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">FinTech Scaling Success</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            A fintech startup scaled from 10K to 10M users in 18 months using Augment Finance AI for fraud detection.
          </p>
