...
export const metadata: Metadata = {
  title: 'Operational Efficiency Stories | Augment AI',
  description: 'Stories focused on process optimization, cost reduction, and productivity improvements through AI automation.',
};

export default function OperationalEfficiencyStoriesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Operational Efficiency Stories</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Stories focused on process optimization, cost reduction, and productivity improvements through AI automation.
          </p>
