...
export const metadata: Metadata = {
  title: 'Scaling Success Stories | Augment AI',
  description: 'How organizations successfully scaled AI implementations from pilot projects to enterprise-wide deployments.',
};

export default function ScalingSuccessStoriesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Scaling Success Stories</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            How organizations successfully scaled AI implementations from pilot projects to enterprise-wide deployments.
          </p>
