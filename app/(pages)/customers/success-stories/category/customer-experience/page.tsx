...
export const metadata: Metadata = {
  title: 'Customer Experience Stories | Augment AI',
  description: 'Stories highlighting dramatic improvements in customer satisfaction, engagement, and service delivery.',
};

export default function CustomerExperienceStoriesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Customer Experience Stories</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Stories highlighting dramatic improvements in customer satisfaction, engagement, and service delivery.
          </p>
