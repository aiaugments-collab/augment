...
export const metadata: Metadata = {
  title: 'Build Credibility | Augment AI',
  description: 'Establish your organization as an AI leader and attract top talent, partners, and customers.',
};

export default function BuildCredibilityPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Build Credibility</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Establish your organization as an AI leader and attract top talent, partners, and customers.
          </p>
