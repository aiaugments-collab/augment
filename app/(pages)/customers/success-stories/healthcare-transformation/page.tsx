...
export const metadata: Metadata = {
  title: 'Healthcare Transformation Story | Augment AI',
  description: 'How a 15-hospital network reduced emergency room wait times by 45% and improved patient satisfaction with Augment Health AI.',
};

export default function HealthcareTransformationStoryPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Healthcare Transformation Story</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Healthcare Transformation Story
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            How a 15-hospital network reduced emergency room wait times by 45% and improved patient satisfaction with Augment Health AI.
          </p>
