...
export const metadata: Metadata = {
  title: 'Quarterly Executive Sessions | Augment AI',
  description: 'Participate in exclusive quarterly sessions with Augment leadership to discuss strategy and roadmap.',
};

export default function QuarterlyExecutiveSessionsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Quarterly Executive Sessions</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Participate in exclusive quarterly sessions with Augment leadership to discuss strategy and roadmap.
          </p>
