...
export const metadata: Metadata = {
  title: 'Executive Networking | Augment AI',
  description: 'Connect with fellow AI leaders and executives from top organizations worldwide in exclusive events.',
};

export default function ExecutiveNetworkingPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Executive Networking</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Connect with fellow AI leaders and executives from top organizations worldwide in exclusive events.
          </p>
