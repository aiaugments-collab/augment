...
export const metadata: Metadata = {
  title: 'AI Ethics & Governance Committee | Augment AI',
  description: 'Guide responsible AI development, ethical considerations, and governance frameworks.',
};

export default function AIEthicsGovernanceCommitteePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Ethics & Governance Committee</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Guide responsible AI development, ethical considerations, and governance frameworks.
          </p>
