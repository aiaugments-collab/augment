...
export const metadata: Metadata = {
  title: 'User Experience Committee | Augment AI',
  description: 'Shape user interfaces, workflows, and overall user experience across all Augment AI products.',
};

export default function UserExperienceCommitteePage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">User Experience Committee</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Shape user interfaces, workflows, and overall user experience across all Augment AI products.
          </p>
