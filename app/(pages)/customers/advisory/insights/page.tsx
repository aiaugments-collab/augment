...
export const metadata: Metadata = {
  title: 'Strategic Market Insights | Augment AI',
  description: 'Access exclusive market research, industry trends, and strategic insights to inform your AI strategy.',
};

export default function StrategicMarketInsightsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Strategic Market Insights</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Access exclusive market research, industry trends, and strategic insights to inform your AI strategy.
          </p>
