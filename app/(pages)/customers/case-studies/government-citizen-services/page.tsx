...
export const metadata: Metadata = {
  title: 'Government Citizen Services | Augment AI',
  description: 'Federal agency improved citizen service delivery by 50% using Augment AI for document processing and workflow automation.',
};

export default function GovernmentCitizenServicesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Government Citizen Services</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Federal agency improved citizen service delivery by 50% using Augment AI for document processing and workflow automation.
          </p>
