...
export const metadata: Metadata = {
  title: 'Healthcare Case Studies | Augment AI',
  description: 'Explore detailed case studies from hospitals, clinics, and pharmaceutical companies transforming patient care with AI.',
};

export default function HealthcareCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Healthcare Case Studies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Explore detailed case studies from hospitals, clinics, and pharmaceutical companies transforming patient care with AI.
          </p>
