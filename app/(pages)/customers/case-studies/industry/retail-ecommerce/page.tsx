...
export const metadata: Metadata = {
  title: 'Retail & E-commerce Case Studies | Augment AI',
  description: 'See how retailers are enhancing customer experience and inventory management through AI-driven insights.',
};

export default function RetailEcommerceCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Retail & E-commerce Case Studies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            See how retailers are enhancing customer experience and inventory management through AI-driven insights.
          </p>
