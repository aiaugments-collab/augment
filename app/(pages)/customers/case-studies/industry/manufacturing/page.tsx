...
export const metadata: Metadata = {
  title: 'Manufacturing Case Studies | Augment AI',
  description: 'Learn how manufacturers are optimizing operations and supply chain management with intelligent automation.',
};

export default function ManufacturingCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Manufacturing Case Studies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Learn how manufacturers are optimizing operations and supply chain management with intelligent automation.
          </p>
