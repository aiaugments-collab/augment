...
export const metadata: Metadata = {
  title: 'Financial Services Case Studies | Augment AI',
  description: 'Discover how banks, insurance companies, and fintech firms are leveraging AI for fraud detection and customer service.',
};

export default function FinancialServicesCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Financial Services Case Studies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover how banks, insurance companies, and fintech firms are leveraging AI for fraud detection and customer service.
          </p>
