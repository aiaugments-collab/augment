...
export const metadata: Metadata = {
  title: 'Technology Case Studies | Augment AI',
  description: 'Discover how tech companies are accelerating development and scaling operations with AI-first approaches.',
};

export default function TechnologyCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Technology Case Studies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover how tech companies are accelerating development and scaling operations with AI-first approaches.
          </p>
