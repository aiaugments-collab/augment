...
export const metadata: Metadata = {
  title: 'Government Case Studies | Augment AI',
  description: 'Explore how government agencies are improving citizen services and operational efficiency with AI solutions.',
};

export default function GovernmentCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Government Case Studies</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Explore how government agencies are improving citizen services and operational efficiency with AI solutions.
          </p>
