...
export const metadata: Metadata = {
  title: 'Manufacturing Efficiency Case Study | Augment AI',
  description: 'Global manufacturer increased production efficiency by 30% and reduced equipment downtime by 45% with Augment Flow.',
};

export default function ManufacturingEfficiencyCaseStudyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Manufacturing Efficiency Case Study</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Global manufacturer increased production efficiency by 30% and reduced equipment downtime by 45% with Augment Flow.
          </p>
