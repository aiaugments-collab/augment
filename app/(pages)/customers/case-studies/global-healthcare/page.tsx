...
export const metadata: Metadata = {
  title: 'Global Healthcare Case Study | Augment AI',
  description: 'Leading healthcare provider transformed patient care and operational efficiency with Augment Health AI solutions.',
};

export default function GlobalHealthcareCaseStudyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Global Healthcare Case Study</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Global Healthcare Case Study
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Leading healthcare provider transformed patient care and operational efficiency with Augment Health AI solutions.
          </p>
