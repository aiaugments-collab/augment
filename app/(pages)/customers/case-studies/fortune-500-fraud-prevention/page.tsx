...
export const metadata: Metadata = {
  title: 'Fortune 500 Fraud Prevention | Augment AI',
  description: 'Major financial institution prevented $50M in fraud losses using Augment Finance AI for real-time transaction monitoring.',
};

export default function Fortune500FraudPreventionPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Fortune 500 Fraud Prevention</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Fortune 500 Fraud Prevention
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Major financial institution prevented $50M in fraud losses using Augment Finance AI for real-time transaction monitoring.
          </p>
