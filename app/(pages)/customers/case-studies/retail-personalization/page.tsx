...
export const metadata: Metadata = {
  title: 'Retail Personalization Success | Augment AI',
  description: 'International retailer boosted online sales by 25% using Augment Search AI for personalized recommendations.',
};

export default function RetailPersonalizationSuccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Retail Personalization Success</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Retail Personalization Success
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            International retailer boosted online sales by 25% using Augment Search AI for personalized recommendations.
          </p>
