...
export const metadata: Metadata = {
  title: 'Submit Case Study | Augment AI',
  description: 'Share your success story and collaborate with us to create a compelling case study for the community.',
};

export default function SubmitCaseStudyPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Submit Case Study</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Share your success story and collaborate with us to create a compelling case study for the community.
          </p>
