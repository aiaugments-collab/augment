...
export const metadata: Metadata = {
  title: 'Customer Reference Program | Augment AI',
  description: 'Become a reference customer and help prospects understand the value of Augment AI solutions while gaining recognition.',
};

export default function CustomerReferenceProgramPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Customer Reference Program</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Become a reference customer and help prospects understand the value of Augment AI solutions while gaining recognition.
          </p>
