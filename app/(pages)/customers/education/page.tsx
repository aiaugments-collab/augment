...
export const metadata: Metadata = {
  title: 'Educational Institutions | Augment AI',
  description: 'Discover how universities, schools, and educational organizations are enhancing learning experiences with AI.',
};

export default function EducationalInstitutionsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Educational Institutions</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discover how universities, schools, and educational organizations are enhancing learning experiences with AI.
          </p>
