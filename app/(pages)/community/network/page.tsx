...
export const metadata: Metadata = {
  title: 'Connect with AI Professionals | Augment AI',
  description: 'Network with AI researchers, developers, business leaders, and innovators from around the world.',
};

export default function ConnectwithAIProfessionalsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Connect with AI Professionals</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Network with AI researchers, developers, business leaders, and innovators from around the world.
          </p>
