...
export const metadata: Metadata = {
  title: 'Business Leaders & Executives | Augment AI',
  description: 'Strategic discussions on AI adoption, transformation, and business impact of artificial intelligence.',
};

export default function BusinessLeadersExecutivesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Business Leaders & Executives</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Strategic discussions on AI adoption, transformation, and business impact of artificial intelligence.
          </p>
