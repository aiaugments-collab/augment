...
export const metadata: Metadata = {
  title: 'Industry Recognition | Augment AI',
...
export default function IndustryRecognitionPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Industry Recognition</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Gain recognition for your contributions and expertise within the global AI community.
          </p>
