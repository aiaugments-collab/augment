...
export const metadata: Metadata = {
  title: 'Exclusive Learning Resources | Augment AI',
  description: 'Access premium content, webinars, and educational materials available only to community members.',
};

export default function ExclusiveLearningResourcesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Exclusive Learning Resources</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Access premium content, webinars, and educational materials available only to community members.
          </p>
