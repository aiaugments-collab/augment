...
export const metadata: Metadata = {
  title: 'Startup Success Stories | Augment AI',
  description: 'Inspiring stories from startups that have achieved remarkable success through our program.',
};

export default function StartupSuccessStoriesPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Startup Success Stories</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Inspiring stories from startups that have achieved remarkable success through our program.
          </p>
