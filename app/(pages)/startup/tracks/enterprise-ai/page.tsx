...
export const metadata: Metadata = {
  title: 'Enterprise AI Track | Augment AI',
  description: 'For B2B startups building enterprise AI solutions with focus on enterprise sales and partnerships.',
};

export default function EnterpriseAITrackPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Enterprise AI Track</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            For B2B startups building enterprise AI solutions with focus on enterprise sales and partnerships.
          </p>
