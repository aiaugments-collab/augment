...
export const metadata: Metadata = {
  title: 'Dedicated Technical Support | Augment AI',
  description: 'Priority technical support, architecture reviews, and direct access to our engineering team.',
};

export default function DedicatedTechnicalSupportPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Dedicated Technical Support</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Priority technical support, architecture reviews, and direct access to our engineering team.
          </p>
