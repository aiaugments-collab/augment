...
export const metadata: Metadata = {
  title: 'Startup Community Network | Augment AI',
  description: 'Join a vibrant community of AI startups for collaboration, knowledge sharing, and peer learning.',
};

export default function StartupCommunityNetworkPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Startup Community Network</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Startup Community Network
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Join a vibrant community of AI startups for collaboration, knowledge sharing, and peer learning.
          </p>
