...
export const metadata: Metadata = {
  title: 'Expert Mentorship Program | Augment AI',
  description: 'Connect with successful entrepreneurs, AI experts, and industry leaders for strategic guidance.',
};

export default function ExpertMentorshipProgramPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Expert Mentorship Program</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Connect with successful entrepreneurs, AI experts, and industry leaders for strategic guidance.
          </p>
