...
export const metadata: Metadata = {
  title: 'Free AI Platform Credits | Augment AI',
  description: 'Up to $100,000 in free Augment AI platform credits to accelerate your development and reduce costs.',
};

export default function FreeAIPlatformCreditsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Free AI Platform Credits</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-normal text-white mb-6" style={{ fontFamily: 'var(--oracleserif)' }}>
            Free AI Platform Credits
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Up to $100,000 in free Augment AI platform credits to accelerate your development and reduce costs.
          </p>
