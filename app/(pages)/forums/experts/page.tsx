...
export const metadata: Metadata = {
  title: 'Expert Community | Augment AI',
...
export default function ExpertCommunityPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Expert Community</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Connect with AI experts, researchers, and practitioners from leading organizations worldwide.
          </p>
