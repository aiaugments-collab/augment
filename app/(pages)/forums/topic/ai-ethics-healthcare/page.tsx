...
export const metadata: Metadata = {
  title: 'AI Ethics in Healthcare Applications | Augment AI',
...
export default function AIEthicsinHealthcareApplicationsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Ethics in Healthcare Applications</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Discussion about ethical considerations when implementing AI in healthcare settings, including bias, privacy, and decision transparency.
          </p>
