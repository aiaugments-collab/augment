...
export const metadata: Metadata = {
  title: 'AI HR Documentation | Augment AI',
...
export default function AIHRDocumentationPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI HR Documentation</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Complete user guide for AI HR solutions including setup, configuration, and advanced features for human resources automation.
          </p>
