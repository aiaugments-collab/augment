...
export const metadata: Metadata = {
  title: 'Flow Documentation | Augment AI',
  description: 'User guide for Flow workflow automation platform including process design, deployment, and monitoring.',
};

export default function FlowDocumentationPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Flow Documentation</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            User guide for Flow workflow automation platform including process design, deployment, and monitoring.
          </p>
