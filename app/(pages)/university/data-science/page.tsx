...
export const metadata: Metadata = {
  title: 'Data Science & Analytics Program | Augment AI',
...
export default function DataScienceAnalyticsProgramPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Data Science & Analytics Program</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Intensive program focusing on data analysis, statistical modeling, and AI-driven insights for business applications.
          </p>
