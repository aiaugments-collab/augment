...
export const metadata: Metadata = {
  title: 'Take Virtual Tour | Augment AI',
  description: 'Experience Augment University through our comprehensive virtual campus tour.',
};

export default function TakeVirtualTourPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Take Virtual Tour</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Experience Augment University through our comprehensive virtual campus tour.
          </p>
