...
export const metadata: Metadata = {
  title: 'Executive AI Leadership Program | Augment AI',
...
export default function ExecutiveAILeadershipProgramPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Executive AI Leadership Program</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Strategic program for executives and senior leaders on AI transformation, digital strategy, and organizational change.
          </p>
