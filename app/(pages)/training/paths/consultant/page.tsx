...
export const metadata: Metadata = {
  title: 'AI Consultant Path | Augment AI',
  description: 'Business-focused training for consultants helping organizations adopt and implement AI strategies.',
};

export default function AIConsultantPathPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">AI Consultant Path</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Business-focused training for consultants helping organizations adopt and implement AI strategies.
          </p>
