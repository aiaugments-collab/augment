...
export const metadata: Metadata = {
  title: 'Corporate Training | Augment AI',
  description: 'Customized AI training programs designed for organizations and enterprise teams.',
};

export default function CorporateTrainingPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Corporate Training</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Customized AI training programs designed for organizations and enterprise teams.
          </p>
