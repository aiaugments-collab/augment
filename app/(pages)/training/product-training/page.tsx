...
export const metadata: Metadata = {
  title: 'Live Training Sessions | Augment AI',
  description: 'Join live training sessions and webinars to learn about product features and best practices.',
};

export default function LiveTrainingSessionsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Live Training Sessions</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Join live training sessions and webinars to learn about product features and best practices.
          </p>
