...
export const metadata: Metadata = {
  title: 'Partner Directory | Augment AI',
  description: 'Browse our directory of certified partners to find the right expertise for your AI implementation needs.',
};

export default function PartnerDirectoryPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Partner Directory</h1>
