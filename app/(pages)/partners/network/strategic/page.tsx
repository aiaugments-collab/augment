...
export const metadata: Metadata = {
  title: 'Strategic Alliance Partners | Augment AI',
  description: 'Strategic partnerships with major technology companies for joint go-to-market initiatives.',
};

export default function StrategicAlliancePartnersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Strategic Alliance Partners</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Strategic partnerships with major technology companies for joint go-to-market initiatives.
          </p>
