...
export const metadata: Metadata = {
  title: 'Exclusive Partner Access | Augment AI',
  description: 'Early access to new products, beta programs, roadmap insights, and exclusive partner events.',
};

export default function ExclusivePartnerAccessPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Exclusive Partner Access</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Early access to new products, beta programs, roadmap insights, and exclusive partner events.
          </p>
