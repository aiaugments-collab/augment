...
export const metadata: Metadata = {
  title: 'Co-Marketing & Sales Support | Augment AI',
  description: 'Joint marketing programs, sales enablement, lead sharing, and co-branded marketing materials.',
};

export default function CoMarketingSalesSupportPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Co-Marketing & Sales Support</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Joint marketing programs, sales enablement, lead sharing, and co-branded marketing materials.
          </p>
