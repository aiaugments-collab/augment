...
export const metadata: Metadata = {
  title: 'Training & Certification Programs | Augment AI',
  description: 'Comprehensive partner training, certification programs, and ongoing education to ensure success.',
};

export default function TrainingCertificationProgramsPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Training & Certification Programs</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Comprehensive partner training, certification programs, and ongoing education to ensure success.
          </p>
