...
export const metadata: Metadata = {
  title: 'Channel & Reseller Partners | Augment AI',
  description: 'Authorized resellers and distributors that sell Augment AI solutions to their customer base and markets.',
};

export default function ChannelResellerPartnersPage() {
  return (
    <main className="min-h-screen bg-white">
      <h1 className="sr-only">Channel & Reseller Partners</h1>
      ...
      <section className="bg-[#312a2a] text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: 'var(--oraclesans)' }}>
            Authorized resellers and distributors that sell Augment AI solutions to their customer base and markets.
          </p>
